# Script para iniciar o Analisador Científico de Websites
...
Write-Host "  ANALISADOR CIENTÍFICO DE WEBSITES" -ForegroundColor Green
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host ""
Write-Host "A interface se abrirá em: http://localhost:8503" -ForegroundColor Cyan
Write-Host ""
Write-Host "Para parar, pressione Ctrl+C" -ForegroundColor Yellow
Write-Host ""

python -m streamlit run src/website_analyzer/website_analyzer_web.py --server.port 8503
