# Script para iniciar o Extrator de Imagens com OCR
...
Write-Host "   EXTRATOR DE IMAGENS COM OCR + SQL" -ForegroundColor Green
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host ""
Write-Host "A interface se abrirá em: http://localhost:8502" -ForegroundColor Cyan
Write-Host ""
